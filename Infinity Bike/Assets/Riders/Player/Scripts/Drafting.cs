...
{   
    ...
    {   
        ...
        if(followingIndicatorPrefab == null)
        {
            followingIndicatorPrefab = GameObject.CreatePrimitive(PrimitiveType.Sphere);
            followingIndicatorPrefab.transform.localScale *= 0.1f;
        }
